...
#         raise ValueError('Coordinates must be at least 2 numbers long')
#     return feature({
#         type: 'Point',
...
#     if not coordinates:
#         raise ValueError('No coordinates passed')
#     return feature({
#         type: 'LineString',
#         coordinates: coordinates
#     }, properties)
...
#  //=multiLine
#
# def multiLineString(coordinates, properties):
#     if not coordinates:
#         raise ValueError('No coordinates passed')
#     return feature({
...
# //=multiPt
#
# def multiPoint(coordinates, properties):
#     if not coordinates:
#         raise ValueError('No coordinates passed')
#     return feature({
#         type: 'MultiPoint',
...
def radians_to_distance (radians, units):
    factor = factors[units or 'kilometers']
    if factor is None:
...
#
# @name distance_to_degrees
# @param {number} distance in real units
# @param {string=kilometers} units: one of miles, nauticalmiles, degrees, radians,
# inches, yards, metres, meters, kilometres, kilometers.
# @returns {number} degrees
#
def distance_to_degrees (distance, units):
    factor = factors[units or 'kilometers']
    if factor is None:
        raise ValueError('Invalid unit')
